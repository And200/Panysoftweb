...
class PersonResourceIT {
    ...
    public static Person createEntity(EntityManager em) {
        Person person = new Person().name(DEFAULT_NAME).email(DEFAULT_EMAIL).adress(DEFAULT_ADRESS);
        // Add required entity
    ...
    public static Person createUpdatedEntity(EntityManager em) {
        Person person = new Person().name(UPDATED_NAME).email(UPDATED_EMAIL).adress(UPDATED_ADRESS);
        // Add required entity
        DocumentType documentType;
        if (TestUtil.findAll(em, DocumentType.class).isEmpty()) {
    ...
    void putNewPerson() throws Exception {
        ...
        updatedPerson.name(UPDATED_NAME).email(UPDATED_EMAIL).adress(UPDATED_ADRESS);
    ...
    void partialUpdatePersonWithPatch() throws Exception {
        ...
        partialUpdatedPerson.adress(UPDATED_ADRESS);
    ...
    void fullUpdatePersonWithPatch() throws Exception {
        ...
        partialUpdatedPerson.name(UPDATED_NAME).email(UPDATED_EMAIL).adress(UPDATED_ADRESS);
