...
class CategoryResourceIT {
    ...
    public static Category createEntity(EntityManager em) {
        Category category = new Category().nameCategory(DEFAULT_NAME_CATEGORY);
        return category;
    }
    ...
    public static Category createUpdatedEntity(EntityManager em) {
        Category category = new Category().nameCategory(UPDATED_NAME_CATEGORY);
        return category;
    }
    ...
    @Test
    @Transactional
    void checkNameCategoryIsRequired() throws Exception {
    ...
    void putNewCategory() throws Exception {
        ...
        updatedCategory.nameCategory(UPDATED_NAME_CATEGORY);
    ...
    void partialUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.nameCategory(UPDATED_NAME_CATEGORY);
