...
class ProductResourceIT {
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product().productDetail(DEFAULT_PRODUCT_DETAIL).productName(DEFAULT_PRODUCT_NAME);
        // Add required entity
        Provider provider;
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product().productDetail(UPDATED_PRODUCT_DETAIL).productName(UPDATED_PRODUCT_NAME);
        // Add required entity
        Provider provider;
        if (TestUtil.findAll(em, Provider.class).isEmpty()) {
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getProductDetail()).isEqualTo(DEFAULT_PRODUCT_DETAIL);
    ...
    @Test
    @Transactional
    void checkProductDetailIsRequired() throws Exception {
    ...
    void getAllProducts() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.[*].productDetail").value(hasItem(DEFAULT_PRODUCT_DETAIL)))
    ...
    void getProduct() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.productDetail").value(DEFAULT_PRODUCT_DETAIL))
    ...
    void putNewProduct() throws Exception {
        ...
        updatedProduct.productDetail(UPDATED_PRODUCT_DETAIL).productName(UPDATED_PRODUCT_NAME);
        ...
        Product testProduct = productList.get(productList.size() - 1);
        assertThat(testProduct.getProductDetail()).isEqualTo(UPDATED_PRODUCT_DETAIL);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.productDetail(UPDATED_PRODUCT_DETAIL).productName(UPDATED_PRODUCT_NAME);
