...
describe('Provider routing resolve service', () => {
  ...
  let routingResolveService: ProviderRoutingResolveService;
  let service: ProviderService;
  let resultProvider: IProvider | undefined;
  ...
  beforeEach(() => {
    ...
    routingResolveService = TestBed.inject(ProviderRoutingResolveService);
  ...
  describe('resolve', () => {
    ...
    it('should return new IProvider if id is not provided', () => {
      // GIVEN
      ...
      expect(resultProvider).toEqual(new Provider());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Provider })));
      mockActivatedRouteSnapshot.params = { id: 123 };
